...
- **Testing**: Added extensive unit and integration tests for Agents, Messages, Error Boundaries, and accessibility.
- **State Management**: Continued migration from Recoil to Jotai (fontSize atom migrated).
