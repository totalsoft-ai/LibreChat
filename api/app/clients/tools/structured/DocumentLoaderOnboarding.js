...
class DocumentLoaderOnboardingTool extends Tool {
  static lc_name() {
    return 'document_loader_onboarding';
  }

  constructor(fields = {}) {
    super(fields);
    this.name = 'document_loader_onboarding';
    this.baseUrl = getEnvironmentVariable('DOCUMENT_LOADER_ONBOARDING_BASE_URL');

    this.description =
      'Upload and process documents (PDF, DOCX, Excel) with automatic personal data detection for onboarding. ' +
...
module.exports = DocumentLoaderOnboardingTool;